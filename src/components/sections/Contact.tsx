...
export default function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Capture the form element immediately to avoid event pooling issues
    ...
    try {
      ...
      // reset the captured form element (safe)
      formEl.reset();
    } catch (err) {
        ...
        <div className="grid gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-6 flex items-center gap-4 text-muted">
              ...
              >
                {/* Instagram SVG */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"><path d="M7 2C4.243 2 2 4.243 2 7v10c0 2.757 2.243 5 5 5h10c2.757 0 5-2.243 5-5V7c0-2.757-2.243-5-5-5H7Zm0 2h10a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Zm5 3a5 5 0 1 0 0 10 5 5 0 0 0 0-10Zm0 2a3 3 0 1 1 0 6 3 3 0 0 1 0-6Zm5-2.75a1.25 1.25 0 1 1-2.5 0 1.25 1.25 0 0 1 2.5 0Z" /></svg>
              </a>
              <a href="https://wa.me/919947099728" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="hover:text-ink">
                {/* WhatsApp SVG */}
                <svg viewBox="0 0 32 32" fill="currentColor" className="h-5 w-5"><path d="M16 .667C7.44.667.667 7.44.667 16c0 2.79.733 5.506 2.128 7.907L.667 31.333l7.68-2.027A15.2 15.2 0 0 0 16 31.333c8.56 0 15.333-6.773 15.333-15.333S24.56.667 16 .667Zm0 27.733a12.36 12.36 0 0 1-6.293-1.72l-.453-.267-4.56 1.2 1.213-4.44-.293-.467a12.34 12.34 0 0 1-1.707-6.24c0-6.84 5.547-12.387 12.387-12.387s12.387 5.547 12.387 12.387S22.84 28.4 16 28.4Zm6.493-9.333c-.347-.173-2.053-1.013-2.373-1.133-.32-.133-.547-.2-.773.2-.227.4-.893 1.133-1.093 1.373-.2.24-.4.267-.747.093-.347-.173-1.467-.533-2.787-1.707-1.04-.92-1.747-2.053-1.947-2.4-.2-.347-.02-.533.153-.706.16-.16.347-.4.52-.6.173-.2.227-.347.347-.587.12-.24.067-.44-.027-.613-.093-.173-.773-1.867-1.053-2.56-.28-.693-.573-.6-.773-.613-.2-.013-.427-.013-.653-.013-.227 0-.6.08-.92.4-.32.32-1.213 1.186-1.213 2.893 0 1.706 1.24 3.36 1.413 3.6.173.24 2.453 3.747 6.013 5.253 3.56 1.507 3.56 1.013 4.2.96.64-.053 2.053-.827 2.347-1.627.293-.8.293-1.48.2-1.627-.093-.147-.347-.24-.693-.413Z"/></svg>
              </a>
            </div>
          </div>
